...
import 'thothithu.dart'; // Import the previous level widget
import 'ain_aiu.dart'; // Import the next level widget
...
class _LearningDzoDziDzuWidgetState extends State<LearningDzoDziDzuWidget > {
  ...
  Future<void> _playPauseAudio() async {
    if (_isPlaying) {
      ...
      await _audioPlayer.play(AssetSource('audios/modul3/Dzho Dzhi Dzhi.mp4')); // Play the Ja Ji Ju sound
    }
    setState(() {
