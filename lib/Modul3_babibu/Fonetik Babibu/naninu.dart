...
import 'mamimu.dart'; // Import the previous level widget
import 'wawiwu.dart'; // Import the next level widget
...
class _LearningNaNiNuWidgetState extends State<LearningNaNiNuWidget > {
  ...
  Future<void> _playPauseAudio() async {
    if (_isPlaying) {
      ...
      await _audioPlayer.play(AssetSource('audios/modul3/Na Ni Nu.mp4')); // Play the Ja Ji Ju sound
    }
    setState(() {
              ...
              child: Column(
                ...
                children: [
                  ...
                  Column(
                    children: [
                      Text(
                        'Belajar mengenal  Huruf Hijaiyah (Na Ni Nu) ',
                        textAlign: TextAlign.center,
