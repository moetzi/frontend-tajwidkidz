...
import 'rariru.dart'; // Import the previous level widget
import 'sasisu.dart'; // Import the next level widget
...
class _LearningZaZiZuWidgetState extends State<LearningZaZiZuWidget> {
  ...
  Future<void> _playPauseAudio() async {
    if (_isPlaying) {
      ...
      await _audioPlayer.play(AssetSource('audios/modul3/Za Zi Zu.mp4')); // Play the Ja Ji Ju sound
    }
    setState(() {
