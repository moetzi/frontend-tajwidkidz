...
import 'kakiku.dart'; // Import the previous level widget
import 'mamimu.dart'; // Import the next level widget
...
class _LearningLaLiLuWidgetState extends State<LearningLaLiLuWidget > {
  ...
  Future<void> _playPauseAudio() async {
    if (_isPlaying) {
      ...
      await _audioPlayer.play(AssetSource('audios/modul3/La Li Lu.mp4')); // Play the Ja Ji Ju sound
    }
    setState(() {
              ...
              child: Column(
                ...
                children: [
                  ...
                  Column(
                    children: [
                      Text(
                        'Belajar mengenal Huruf Hijaiyah (La Li Lu) ',
                        textAlign: TextAlign.center,
                    ...
                    children: [
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(builder: (context) => const LearningKaKiKuWidget()),
                          );
                        },
                      ),
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(builder: (context) => const LearningMaMiMuWidget()),
                          );
                        },
                      ),
                    ],
