...
import 'zazizu.dart'; // Import the previous level widget
import 'syasyisyu.dart'; // Import the next level widget
...
class _LearningSaSiSuWidgetState extends State<LearningSaSiSuWidget> {
  ...
  Future<void> _playPauseAudio() async {
    if (_isPlaying) {
      ...
      await _audioPlayer.play(AssetSource('audios/modul3/Sa Si Su(1).wav')); // Play the Ja Ji Ju sound
    }
    setState(() {
