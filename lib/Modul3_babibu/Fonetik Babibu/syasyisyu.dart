...
import 'sasisu.dart'; // Import the previous level widget
import 'shoshishu.dart'; // Import the next level widget
...
class _LearningSyaSyiSyuWidgetState extends State<LearningSyaSyiSyuWidget> {
  ...
  Future<void> _playPauseAudio() async {
    if (_isPlaying) {
      ...
      await _audioPlayer.play(AssetSource('audios/modul3/Sya Syi Syu.mp4')); // Play the Ja Ji Ju sound
    }
    setState(() {
                    ...
                    children: [
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(builder: (context) => const LearningSaSiSuWidget()),
                          );
                        },
                      ),
                      IconButton(
