...
import 'lalilu.dart'; // Import the previous level widget
import 'naninu.dart'; // Import the next level widget
...
class _LearningMaMiMuWidgetState extends State<LearningMaMiMuWidget > {
  ...
  Future<void> _playPauseAudio() async {
    if (_isPlaying) {
      ...
      await _audioPlayer.play(AssetSource('audios/modul3/Ma Mi Mu.mp4')); // Play the Ja Ji Ju sound
    }
    setState(() {
              ...
              child: Column(
                ...
                children: [
                  ...
                  Column(
                    children: [
                      Text(
                        'Belajar mengenal Huruf Hijaiyah (Ma Mi Mu) ',
                        textAlign: TextAlign.center,
