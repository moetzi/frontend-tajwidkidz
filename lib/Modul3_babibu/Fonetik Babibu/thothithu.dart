...
import 'dhodhidhu.dart'; // Import the previous level widget
import 'dzodzidzu.dart'; // Import the next level widget
...
class _LearningThoThiThuWidgetState extends State< LearningThoThiThuWidget> {
  ...
  Future<void> _playPauseAudio() async {
    if (_isPlaying) {
      ...
      await _audioPlayer.play(AssetSource('audios/modul3/Tho Thi Thu.mp4')); // Play the Ja Ji Ju sound
    }
    setState(() {
