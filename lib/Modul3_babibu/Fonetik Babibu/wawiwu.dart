...
import 'naninu.dart'; // Import the previous level widget
import 'hahihu1.dart'; // Import the next level widget
...
class LearningWaWiWuWidget extends StatefulWidget {
  ...
  static String routeName = 'Learningwawiwu';
  static String routePath = '/learningwawiwu';
...
class _LearningWaWiWuWidgetState extends State<LearningWaWiWuWidget> {
  ...
  Future<void> _playPauseAudio() async {
    if (_isPlaying) {
      ...
      await _audioPlayer.play(AssetSource('audios/modul3/Wa Wi Wu.mp4')); // Play the Ja Ji Ju sound
    }
    setState(() {
                    ...
                    children: [
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(builder: (context) => const LearningNaNiNuWidget()),
                          );
                        },
                      ),
                      IconButton(
