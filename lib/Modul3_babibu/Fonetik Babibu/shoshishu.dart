...
import 'syasyisyu.dart'; // Import the previous level widget
import 'dhodhidhu.dart'; // Import the next level widget
...
class _LearningShoShiShuWidgetState extends State<LearningShoShiShuWidget> {
  ...
  Future<void> _playPauseAudio() async {
    if (_isPlaying) {
      ...
      await _audioPlayer.play(AssetSource('audios/modul3/Dho Dhi Dhu.mp4')); // Play the Ja Ji Ju sound
    }
    setState(() {
                    ...
                    children: [
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(builder: (context) => const LearningSyaSyiSyuWidget()),
                          );
                        },
                      ),
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(builder: (context) => const LearningDhoDhiDhuWidget()),
                          );
                        },
                      ),
                    ],
