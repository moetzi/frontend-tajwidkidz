...
import 'm1dal.dart';  // Import LearningDalWidget (previous level)
...
class LearningDzalWidget extends StatefulWidget {
  ...
  static String routeName = 'LearningDzal';
  static String routePath = '/learningDzal';

  @override
  State<LearningDzalWidget> createState() => _LearningDzalWidgetState();
}

class _LearningDzalWidgetState extends State<LearningDzalWidget> {
  ...
  void _playPauseAudio() async {
    if (_isPlaying) {
      ...
      await _audioPlayer.play(AssetSource('audios/modul1/dzal_8.wav'));
    }
    setState(() {
                ...
                Center(
                  child: SizedBox(
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(8),
                      child: Image.asset(
                        'assets/images/m1/m1dza.png', // Path to your image of the throat position for Ta
