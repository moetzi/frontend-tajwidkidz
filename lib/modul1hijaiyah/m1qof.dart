...
class LearningQofWidget extends StatefulWidget {
  const LearningQofWidget({super.key});

  static String routeName = 'LearningQof';
  static String routePath = '/learningQof';

  @override
  State<LearningQofWidget> createState() => _LearningQofWidgetState();
}

class _LearningQofWidgetState extends State<LearningQofWidget> {
  ...
  void _playPauseAudio() async {
    if (_isPlaying) {
      ...
      await _audioPlayer.play(AssetSource('audios/modul1/qaf_20.wav'));
    }
    setState(() {
              ...
              children: [
                ...
                Center(
                  child: SizedBox(
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(8),
                      child: Image.asset(
                        'assets/images/m1/m1qof.png', // Path to your image of the throat position for Ta
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Penjelasan Huruf Qof (ق):',
                        style: GoogleFonts.inter(fontSize: 18, fontWeight: FontWeight.w600),
                      ),
                      const SizedBox(height: 10),
                      Text(
                        'Al-Lisan (Lidah)\n'
                            'Pangkal lidah bertemu langit-langit bagian belakang.',
