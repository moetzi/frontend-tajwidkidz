...
import 'm1ta.dart';  // Import LearningTaWidget for the previous level
import 'm1jim.dart';  // Import LearningJimWidget for the next level
...
class LearningTsaWidget extends StatefulWidget {
  ...
  static String routeName = 'LearningTsa';
  static String routePath = '/learningTsa';

  @override
  State<LearningTsaWidget> createState() => _LearningTsaWidgetState();
}

class _LearningTsaWidgetState extends State<LearningTsaWidget> {
  ...
  void _playPauseAudio() async {
    if (_isPlaying) {
      ...
      await _audioPlayer.play(AssetSource('audios/modul1/tsa_4.wav')); // Play the tsa sound
    }
    setState(() {
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      // Fast Forward Button to navigate to LearningJimWidget (next page)
                      IconButton(
                        icon: const Icon(
                          Icons.fast_forward,
                          color: Colors.black,
                        ...
                        onPressed: () {
                          // Navigate to LearningJimWidget (next page)
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                ...
                // Gambar tenggorokan cara baca Tsa (With the throat image)
                ...
                Center(
                  child: Container(
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(8),
                      child: Image.asset(
                        'assets/images/m1/m1tsa.png', // Path to your image of the throat position for Tsa
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 10),
                      Text(
                        'd. Antara punggung ujung lidah dan ujung dua gigi yang atas',
                        style: GoogleFonts.inter(
                          fontSize: 16,
