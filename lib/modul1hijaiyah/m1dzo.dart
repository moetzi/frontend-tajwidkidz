...
class LearningDzoWidget extends StatefulWidget {
  const LearningDzoWidget({super.key});

  static String routeName = 'LearningDzo';
  static String routePath = '/learningDzo';

  @override
  State<LearningDzoWidget> createState() => _LearningDzoWidgetState();
}

class _LearningDzoWidgetState extends State<LearningDzoWidget> {
  ...
  void _playPauseAudio() async {
    if (_isPlaying) {
      ...
      await _audioPlayer.play(AssetSource('audios/modul1/zha_16.wav'));
    }
    setState(() {
              ...
              children: [
                    ...
                    children: [
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(builder: (context) => const LearningThoWidget()),
                          );
                        },
                      ),
                      IconButton(
                ...
                Center(
                  child: SizedBox(
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(8),
                      child: Image.asset(
                        'assets/images/m1/m1dzo.png', // Path to your image of the throat position for Ta
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Penjelasan Huruf Dzo (ظ):',
                        style: GoogleFonts.inter(fontSize: 18, fontWeight: FontWeight.w600),
                      ),
                      const SizedBox(height: 10),
                      Text(
                        'Antara punggung ujung lidah dan ujung dua gigi yang atas',
