...
class _LearningRaWidgetState extends State<LearningRaWidget> {
  ...
  late final AudioModel raAudioModel;
  ...
  void _playPauseAudio() async {
    if (_isPlaying) {
      ...
      await audioController.play(raAudioModel.fileName);
    }
  }
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                              builder: (context) => LearningDzalWidget(), // Previous level
                            ),
                          );
                        },
                      ),
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                              builder: (context) => LearningZaWidget(), // Next level
                            ),
                          );
                        },
                      ),
