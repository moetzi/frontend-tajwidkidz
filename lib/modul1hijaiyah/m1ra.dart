...
class LearningRaWidget extends StatefulWidget {
  const LearningRaWidget({super.key});

  static String routeName = 'LearningRa';
  static String routePath = '/learningRa';

  @override
  State<LearningRaWidget> createState() => _LearningRaWidgetState();
}

class _LearningRaWidgetState extends State<LearningRaWidget> {
  ...
  void _playPauseAudio() async {
    if (_isPlaying) {
      ...
      await _audioPlayer.play(AssetSource('audios/modul1/ra_9.wav'));
    }
    setState(() {
                    ...
                    children: [
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(builder: (context) => const LearningZaWidget()),
                          );
                        },
                      ),
                    ],
                ...
                Center(
                  child: SizedBox(
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(8),
                      child: Image.asset(
                        'assets/images/m1/m1ra.png', // Path to your image of the throat position for Ta
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        '2. Suara tidak tercegah dengan sempurna dan tidak terlepas dengan sempurna (Bainiyah)',
