...
class LearningFaWidget extends StatefulWidget {
  const LearningFaWidget({super.key});

  static String routeName = 'LearningFa';
  static String routePath = '/learningFa';

  @override
  State<LearningFaWidget> createState() => _LearningFaWidgetState();
}

class _LearningFaWidgetState extends State<LearningFaWidget> {
  ...
  void _playPauseAudio() async {
    if (_isPlaying) {
      ...
      await _audioPlayer.play(AssetSource('audios/modul1/fa_19.wav'));
    }
    setState(() {
              ...
              children: [
                ...
                Center(
                  child: SizedBox(
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(8),
                      child: Image.asset(
                        'assets/images/m1/m1fa.png', // Path to your image of the throat position for Ta
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Penjelasan Huruf Fa (ف):',
                        style: GoogleFonts.inter(fontSize: 18, fontWeight: FontWeight.w600),
                      ),
                      const SizedBox(height: 10),
                      Text(
                        'Asy-Syafataini (2 Bibir)\nPerut bibir bawah dan ujung 2 gigi atas',
