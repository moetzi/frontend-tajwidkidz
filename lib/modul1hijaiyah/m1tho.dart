...
class LearningThoWidget extends StatefulWidget {
  ...
  static String routePath = '/learningSTho';
...
class _LearningThoWidgetState extends State<LearningThoWidget> {
  ...
  late final AudioModel thoAudioModel;
  ...
  void _playPauseAudio() async {
    if (_isPlaying) {
      ...
      await audioController.play(thoAudioModel.fileName);
    }
  }
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                              builder: (context) => LearningDzoWidget(),
                            ),
                          );
                        },
                      ),
