...
class _LearningSinWidgetState extends State<LearningSinWidget> {
  ...
  void _playPauseAudio() async {
    if (_isPlaying) {
      ...
      await _audioPlayer.play(AssetSource('audios/modul1/sin_11.wav'));
    }
    setState(() {
                ...
                Center(
                  child: SizedBox(
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(8),
                      child: Image.asset(
                        'assets/images/m1/m1sin.png', // Path to your image of the throat position for Ta
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('5. Suara berdesis (Shafir)', style: GoogleFonts.inter(fontSize: 16)),
                    ],
                  ),
                ),
                const SizedBox(height: 35),
