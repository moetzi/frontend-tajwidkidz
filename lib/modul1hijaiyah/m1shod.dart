...
class LearningShodWidget extends StatefulWidget {
  const LearningShodWidget({super.key});

  static String routeName = 'LearningShod';
  static String routePath = '/learningShod';

  @override
  State<LearningShodWidget> createState() => _LearningShodWidgetState();
}

class _LearningShodWidgetState extends State<LearningShodWidget> {
  ...
  void _playPauseAudio() async {
    if (_isPlaying) {
      ...
      await _audioPlayer.play(AssetSource('audios/modul1/shad_13.wav'));
    }
    setState(() {
                    ...
                    children: [
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(builder: (context) => const LearningSyinWidget()),
                          );
                        },
                      ),
                      IconButton(
                ...
                Center(
                  child: SizedBox(
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(8),
                      child: Image.asset(
                        'assets/images/m1/m1shod.png', // Path to your image of the throat position for Ta
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('4. Lidah bertemu/nempel dengan langit-langit (Ithbaq)', style: GoogleFonts.inter(fontSize: 16)),
                      Text('5. Tidak lancar dan hati-hati (Ishmat)', style: GoogleFonts.inter(fontSize: 16)),
                      Text('6. Suara berdesir (Shafir)', style: GoogleFonts.inter(fontSize: 16)),
                    ],
                  ),
                ),
                const SizedBox(height: 35),
