...
class LearningBaWidget extends StatefulWidget {
  ...
  static String routeName = 'LearningBa';
  static String routePath = '/learningBa';

  @override
  State<LearningBaWidget> createState() => _LearningBaWidgetState();
}

class _LearningBaWidgetState extends State<LearningBaWidget> {
  ...
  late final AudioModel baAudioModel;
  ...
  void _playPauseAudio() async {
    if (_isPlaying) {
      ...
      await audioController.play(baAudioModel.fileName);
    }
  }
