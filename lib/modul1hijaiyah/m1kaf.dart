...
class LearningKafWidget extends StatefulWidget {
  ...
  static String routeName = 'LearningKaf';
  static String routePath = '/learningKaf';

  @override
  State<LearningKafWidget> createState() => _LearningKafWidgetState();
}

class _LearningKafWidgetState extends State<LearningKafWidget> {
  ...
  void _playPauseAudio() async {
    if (_isPlaying) {
      ...
      await _audioPlayer.play(AssetSource('audios/modul1/kaf_21.wav'));
    }
    setState(() {
              ...
              children: [
                    ...
                    children: [
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(builder: (context) => const LearningQofWidget()),
                          );
                        },
                      ),
                      IconButton(
                ...
                Center(
                  child: SizedBox(
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(8),
                      child: Image.asset(
                        'assets/images/m1/m1kaf.png', // Path to your image of the throat position for Ta
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Penjelasan Huruf Kaf (ك):',
                        style: GoogleFonts.inter(fontSize: 18, fontWeight: FontWeight.w600),
                      ),
                      const SizedBox(height: 10),
                      Text(
                        'Al-Lisan (Lidah)\n'
                            'Pangkal lidah bertemu langit-langit bagian tengah, lebih maju dari makhraj Qof.',
