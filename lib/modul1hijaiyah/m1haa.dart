...
class _LearningHaaWidgetState extends State<LearningHaaWidget> {
  ...
  late final AudioModel haaAudioModel;
  ...
  void initState() {
    ...
    haaAudioModel = AudioModel(label: 'Haa', fileName: 'Modul1/haa_25.wav');
  ...
  void _playPauseAudio() async {
    if (_isPlaying) {
      ...
      await audioController.play(haaAudioModel.fileName);
    }
  }
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => LearningYaWidget()
                            ),
                          );
                        },
                      ),
