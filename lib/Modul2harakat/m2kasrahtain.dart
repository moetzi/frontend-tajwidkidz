...
import 'm2kasrah.dart';
import 'm2dhammah.dart'; // Import LearningBaWidget
...
class _LearningKasrahtainWidgetState extends State<LearningKasrahtainWidget> {
  ...
  late final AudioModel kasrahtainAudioModel;
  ...
  void initState() {
    ...
    kasrahtainAudioModel = AudioModel(label: 'Kahsrahtain', fileName: 'Modul2/Kashrahtain.wav');
  ...
  void _playPauseAudio() async {
    if (_isPlaying) {
      ...
      await audioController.play(kasrahtainAudioModel.fileName);
    }
  }
                    ...
                    children: [
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => LearningKasrahWidget()),
                          );
                        },
                      ),
                      IconButton(
