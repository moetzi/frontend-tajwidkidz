...
class _LearningDhammahWidgetState extends State<LearningDhammahWidget> {
  ...
  late final AudioModel dhammahAudioModel;
  ...
  void initState() {
    ...
    dhammahAudioModel = AudioModel(label: 'Dhammah', fileName: 'Modul2/Dhammah.wav');
  ...
  void _playPauseAudio() async {
    if (_isPlaying) {
      ...
      await audioController.play(dhammahAudioModel.fileName);
    }
  }
                    ...
                    children: [
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => LearningDhammahtainWidget()),
                          );
                        },
                      ),
                    ],
