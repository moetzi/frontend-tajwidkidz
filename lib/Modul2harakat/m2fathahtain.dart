...
import 'm2fathah.dart';
import 'm2kasrah.dart'; // Import LearningBaWidget
...
class _LearningFathahtainWidgetState extends State<LearningFathahtainWidget> {
  ...
  late final AudioModel fathahtainAudioModel;
  ...
  void initState() {
    ...
    fathahtainAudioModel = AudioModel(label: 'Fathahtain', fileName: 'Modul2/Fathahtain.wav');
  ...
  void _playPauseAudio() async {
    if (_isPlaying) {
      ...
      await audioController.play(fathahtainAudioModel.fileName);
    }
  }
