...
class _LearningTasydidWidgetState extends State<LearningTasydidWidget > {
  ...
  late final AudioModel tasydidAudioModel;
  ...
  void initState() {
    ...
    tasydidAudioModel = AudioModel(label: 'Tasydid', fileName: 'Modul2/Tasydid.wav');
  ...
  void _playPauseAudio() async {
    if (_isPlaying) {
      ...
      await audioController.play(tasydidAudioModel.fileName);
    }
  }
