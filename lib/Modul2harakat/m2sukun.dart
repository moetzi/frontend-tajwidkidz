...
import 'm2tasydid.dart'; // Import LearningBaWidget
...
class _LearningSukunWidgetState extends State<LearningSukunWidget> {
  ...
  late final AudioModel sukunAudioModel;
  ...
  void initState() {
    ...
    sukunAudioModel = AudioModel(label: 'Sukun', fileName: 'Modul2/Sukun.wav');
  ...
  void _playPauseAudio() async {
    if (_isPlaying) {
      ...
      await audioController.play(sukunAudioModel.fileName);
    }
  }
                    ...
                    children: [
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => LearningTasydidWidget()),
                          );
                        },
                      ),
                    ],
