...
import 'm2fathahtain.dart'; // Import LearningBaWidget
...
class LearningFathahWidget extends StatefulWidget {
  ...
  static String routeName = 'Learningm2fathah';
  static String routePath = '/learningm2fathah';
...
class _LearningFathahWidgetState extends State<LearningFathahWidget> {
  ...
  late final AudioModel fathahAudioModel;
  ...
  void initState() {
    ...
    fathahAudioModel = AudioModel(label: 'Fathah', fileName: 'Modul2/Fathah.wav');
  ...
  void _playPauseAudio() async {
    if (_isPlaying) {
      ...
      await audioController.play(fathahAudioModel.fileName);
    }
  }
