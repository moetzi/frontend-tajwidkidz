...
class LearningDhammahtainWidget extends StatefulWidget {
  ...
  static String routeName = 'LearningDhammahtain';
  static String routePath = '/learningDhammahtain';
                            ...
                            IconButton(
                              ...
                              onPressed: () {
                                Navigator.pushReplacement(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => LearningdhammahWidget(),
                                  ),
                                );
                              },
                            ),
                              ...
                              child: IconButton(
                                ...
                                onPressed: () {
                                  Navigator.pushReplacement(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => LearningSukunWidget(),
                                    ),
                                  );
                                },
                              ),
