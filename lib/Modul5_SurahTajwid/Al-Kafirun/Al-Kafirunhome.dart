...
import 'Al-Kafirun.dart'; // Import LearningAlfatihahFullWidget
import 'Al-Kafirun1.dart'; // Import LearningAlfatihah1Widget
                                ...
                                child: ElevatedButton(
                                  onPressed: () {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                          builder: (context) => LearningAlkafirunfullWidget()
                                      ),
                                    );
                                  },
                                  child: Row(
