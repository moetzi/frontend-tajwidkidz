...
import 'Al-Kafirun2.dart';
import 'Al-Kafirun4.dart';

class LearningAlkafirun3Widget extends StatefulWidget {
  const LearningAlkafirun3Widget({super.key});

  static String routeName = 'LearningAl-Kafirun3';
  static String routePath = '/learningAl-Kafirun3';

  @override
  State<LearningAlkafirun3Widget> createState() =>
      _LearningAlkafirun3WidgetState();
}

class _LearningAlkafirun3WidgetState
    extends State<LearningAlkafirun3Widget> {
                            ...
                            IconButton(
                              ...
                              onPressed: () {
                                Navigator.pushReplacement(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => LearningAlkafirun2Widget(),
                                  ),
                                );
                              },
                            ),
                              ...
                              child: IconButton(
                                ...
                                onPressed: () {
                                  Navigator.pushReplacement(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => LearningAlkafirun4Widget(),
                                    ),
                                  );
                                },
                              ),
