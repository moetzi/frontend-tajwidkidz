...
import 'Al-Kafirun3.dart';
import 'Al-Kafirun5.dart';

class LearningAlkafirun4Widget extends StatefulWidget {
  const LearningAlkafirun4Widget({super.key});

  static String routeName = 'LearningAl-Kafirun4';
  static String routePath = '/learningAl-Kafirun4';

  @override
  State<LearningAlkafirun4Widget> createState() =>
      _LearningAlkafirun4WidgetState();
}

class _LearningAlkafirun4WidgetState
    extends State<LearningAlkafirun4Widget> {
                            ...
                            IconButton(
                              ...
                              onPressed: () {
                                Navigator.pushReplacement(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => LearningAlkafirun3Widget(),
                                  ),
                                );
                              },
                            ),
                              ...
                              child: IconButton(
                                ...
                                onPressed: () {
                                  Navigator.pushReplacement(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => LearningAlkafirun5Widget(),
                                    ),
                                  );
                                },
                              ),
