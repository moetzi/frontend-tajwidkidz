...
class LearningAlkafirun6Widget extends StatefulWidget {
  ...
  static String routeName = 'LearningAl-Kafirun6';
  static String routePath = '/learningAl-Kafirun6';

  @override
  State<LearningAlkafirun6Widget> createState() =>
      _LearningAlkafirun6WidgetState();
}

class _LearningAlkafirun6WidgetState
    extends State<LearningAlkafirun6Widget> {
