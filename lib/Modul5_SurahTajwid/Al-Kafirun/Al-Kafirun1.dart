...
class LearningAlkafirun1Widget extends StatefulWidget {
  ...
  static String routeName = 'LearningAl-Kafirun1';
  static String routePath = '/learningAl-Kafirun1';

  @override
  State<LearningAlkafirun1Widget> createState() =>
      _LearningAlkafirun1WidgetState();
}

class _LearningAlkafirun1WidgetState
    extends State<LearningAlkafirun1Widget> {
