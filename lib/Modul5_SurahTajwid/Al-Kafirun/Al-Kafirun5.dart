...
import 'Al-Kafirun6.dart';

class LearningAlkafirun5Widget extends StatefulWidget {
  const LearningAlkafirun5Widget({super.key});

  static String routeName = 'LearningAl-Kafirun5';
  static String routePath = '/learningAl-Kafirun5';

  @override
  State<LearningAlkafirun5Widget> createState() =>
      _LearningAlkafirun5WidgetState();
}

class _LearningAlkafirun5WidgetState
    extends State<LearningAlkafirun5Widget> {
                              ...
                              child: IconButton(
                                ...
                                onPressed: () {
                                  Navigator.pushReplacement(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => LearningAlkafirun6Widget(),
                                    ),
                                  );
                                },
                              ),
