...
import 'Al-Kafirun1.dart';
import 'Al-Kafirun3.dart';

class LearningAlkafirun2Widget extends StatefulWidget {
  const LearningAlkafirun2Widget({super.key});

  static String routeName = 'LearningAl-Kafirun2';
  static String routePath = '/learningAl-Kafirun2';

  @override
  State<LearningAlkafirun2Widget> createState() =>
      _LearningAlkafirun2WidgetState();
}

class _LearningAlkafirun2WidgetState
    extends State<LearningAlkafirun2Widget> {
                            ...
                            IconButton(
                              ...
                              onPressed: () {
                                Navigator.pushReplacement(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => LearningAlkafirun1Widget(),
                                  ),
                                );
                              },
                            ),
