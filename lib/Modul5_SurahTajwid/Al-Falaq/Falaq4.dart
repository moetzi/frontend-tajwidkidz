...
class LearningAlfalaq4Widget extends StatefulWidget {
  ...
  @override
  State<LearningAlfalaq4Widget> createState() =>
      _LearningAlfalaq4WidgetState();
}

class _LearningAlfalaq4WidgetState
    extends State<LearningAlfalaq4Widget> {
                            ...
                            IconButton(
                              ...
                              onPressed: () {
                                Navigator.pushReplacement(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => LearningAlfalaq3Widget(),
                                  ),
                                );
                              },
                            ),
                              ...
                              child: IconButton(
                                ...
                                onPressed: () {
                                  Navigator.pushReplacement(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => LearningAlfalaq5Widget(),
                                    ),
                                  );
                                },
                              ),
