...
class LearningAlfalaq3Widget extends StatefulWidget {
  ...
  @override
  State<LearningAlfalaq3Widget> createState() =>
      _LearningAlfalaq3WidgetState();
}

class _LearningAlfalaq3WidgetState
    extends State<LearningAlfalaq3Widget> {
                            ...
                            IconButton(
                              ...
                              onPressed: () {
                                Navigator.pushReplacement(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => LearningAlfalaq2Widget(),
                                  ),
                                );
                              },
                            ),
                              ...
                              child: IconButton(
                                ...
                                onPressed: () {
                                  Navigator.pushReplacement(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => LearningAlfalaq4Widget(),
                                    ),
                                  );
                                },
                              ),
