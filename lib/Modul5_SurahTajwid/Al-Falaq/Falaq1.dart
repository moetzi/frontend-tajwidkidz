...
class LearningAlfalaq1Widget extends StatefulWidget {
  ...
  static String routePath = '/learninFalaq1';

  @override
  State<LearningAlfalaq1Widget> createState() =>
      _LearningAlfalaq1WidgetState();
}

class _LearningAlfalaq1WidgetState
    extends State<LearningAlfalaq1Widget> {
