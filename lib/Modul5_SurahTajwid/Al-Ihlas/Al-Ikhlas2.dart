...
import 'Al-Ikhlas1.dart';
import 'Al-Ikhlas3.dart';

class LearningAlikhlas2Widget extends StatefulWidget {
  const LearningAlikhlas2Widget ({super.key});

  static String routeName = 'LearningAl-Ikhlas2';
  static String routePath = '/learningAl-Ikhlas2';

  @override
  State<LearningAlikhlas2Widget> createState() =>
      _LearningAlikhlas2WidgetState();
}

class _LearningAlikhlas2WidgetState
    extends State<LearningAlikhlas2Widget> {
                              ...
                              child: IconButton(
                                ...
                                onPressed: () {
                                  Navigator.pushReplacement(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => LearningAlikhlas3Widget(),
                                    ),
                                  );
                                },
                              ),
