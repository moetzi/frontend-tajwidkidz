...
class LearningAlikhlas1Widget extends StatefulWidget {
  ...
  static String routeName = 'LearningAl-Ikhlas1';
  static String routePath = '/learningAl-Ikhlas1';

  @override
  State<LearningAlikhlas1Widget> createState() =>
      _LearningAlikhlas1WidgetState();
}

class _LearningAlikhlas1WidgetState
    extends State<LearningAlikhlas1Widget> {
