...
class LearningAnNas6Widget extends StatefulWidget {
  ...
  @override
  State<LearningAnNas6Widget> createState() =>
      _LearningAnNas6WidgetState();
}

class _LearningAnNas6WidgetState
    extends State<LearningAnNas6Widget> {
                            ...
                            IconButton(
                              ...
                              onPressed: () {
                                Navigator.pushReplacement(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => LearningAnNas5Widget(),
                                  ),
                                );
                              },
                            ),
