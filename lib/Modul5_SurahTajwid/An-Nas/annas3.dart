...
class LearningAnNas3Widget extends StatefulWidget {
  ...
  @override
  State<LearningAnNas3Widget> createState() =>
      _LearningAnNas3WidgetState();
}

class _LearningAnNas3WidgetState
    extends State<LearningAnNas3Widget> {
                            ...
                            IconButton(
                              ...
                              onPressed: () {
                                Navigator.pushReplacement(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => LearningAnNas2Widget(),
                                  ),
                                );
                              },
                            ),
