...
class LearningAnNas5Widget extends StatefulWidget {
  ...
  @override
  State<LearningAnNas5Widget> createState() =>
      _LearningAnNas5WidgetState();
}

class _LearningAnNas5WidgetState
    extends State<LearningAnNas5Widget> {
                            ...
                            IconButton(
                              ...
                              onPressed: () {
                                Navigator.pushReplacement(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => LearningAnNas4Widget(),
                                  ),
                                );
                              },
                            ),
                              ...
                              child: IconButton(
                                ...
                                onPressed: () {
                                  Navigator.pushReplacement(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => LearningAnNas6Widget(),
                                    ),
                                  );
                                },
                              ),
                            ...
                            child: Container(
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.asset(
                                  ...
                                  height: MediaQuery.sizeOf(context).height * 0.520,
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
