...
class LearningAnNas2Widget extends StatefulWidget {
  ...
  @override
  State<LearningAnNas2Widget> createState() =>
      _LearningAnNas2WidgetState();
}

class _LearningAnNas2WidgetState
    extends State<LearningAnNas2Widget> {
                              ...
                              child: IconButton(
                                ...
                                onPressed: () {
                                  Navigator.pushReplacement(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => LearningAnNas3Widget(),
                                    ),
                                  );
                                },
                              ),
