...
import 'Al-Kausar1.dart';
import 'Al-Kausar3.dart';

class LearningAlkausar2Widget extends StatefulWidget {
  const LearningAlkausar2Widget({super.key});

  static String routeName = 'LearningAl-Kausar2';
  static String routePath = '/learningAl-Kausar2';

  @override
  State<LearningAlkausar2Widget> createState() =>
      _LearningAlkausar2WidgetState();
}

class _LearningAlkausar2WidgetState
    extends State<LearningAlkausar2Widget> {
                              ...
                              child: IconButton(
                                ...
                                onPressed: () {
                                  Navigator.pushReplacement(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => LearningAlkausar3Widget(),
                                    ),
                                  );
                                },
                              ),
