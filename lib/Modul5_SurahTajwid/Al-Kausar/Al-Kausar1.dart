...
class LearningAlkausar1Widget extends StatefulWidget {
  ...
  static String routeName = 'LearningAl-Kausar1';
  static String routePath = '/learningAl-Kausar1';

  @override
  State<LearningAlkausar1Widget> createState() =>
      _LearningAlkausar1WidgetState();
}

class _LearningAlkausar1WidgetState
    extends State<LearningAlkausar1Widget> {
