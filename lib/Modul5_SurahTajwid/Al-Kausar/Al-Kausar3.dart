...
import 'Al-Kausar2.dart';

class LearningAlkausar3Widget extends StatefulWidget {
  const LearningAlkausar3Widget({super.key});

  static String routeName = 'LearningAl-Kausar3';
  static String routePath = '/learningAl-Kausar3';

  @override
  State<LearningAlkausar3Widget> createState() =>
      _LearningAlkausar3WidgetState();
}

class _LearningAlkausar3WidgetState
    extends State<LearningAlkausar3Widget> {
                            ...
                            IconButton(
                              ...
                              onPressed: () {
                                Navigator.pushReplacement(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => LearningAlkausar2Widget(),
                                  ),
                                );
                              },
                            ),
