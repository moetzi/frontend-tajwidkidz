...
class LearningAlfatihah4Widget extends StatefulWidget {
  ...
  @override
  State<LearningAlfatihah4Widget> createState() =>
      _LearningAlfatihah4WidgetState();
}

class _LearningAlfatihah4WidgetState
    extends State<LearningAlfatihah4Widget> {
                            ...
                            IconButton(
                              ...
                              onPressed: () {
                                Navigator.pushReplacement(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => LearningAlfatihah3Widget(),
                                  ),
                                );
                              },
                            ),
