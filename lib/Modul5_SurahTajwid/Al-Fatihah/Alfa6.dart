...
class LearningAlfatihah6Widget extends StatefulWidget {
  ...
  @override
  State<LearningAlfatihah6Widget> createState() =>
      _LearningAlfatihah6WidgetState();
}

class _LearningAlfatihah6WidgetState
    extends State<LearningAlfatihah6Widget> {
                            ...
                            IconButton(
                              ...
                              onPressed: () {
                                Navigator.pushReplacement(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => LearningAlfatihah5Widget(),
                                  ),
                                );
                              },
                            ),
                              ...
                              child: IconButton(
                                ...
                                onPressed: () {
                                  Navigator.pushReplacement(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) => LearningAlfatihah7Widget(),
                                    ),
                                  );
                                },
                              ),
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.asset(
                                  'assets/images/Alfa6(1).png',
                                  width: MediaQuery.sizeOf(context).width * 0.800,
