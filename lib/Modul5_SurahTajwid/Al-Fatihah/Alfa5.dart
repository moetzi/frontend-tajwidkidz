...
class LearningAlfatihah5Widget extends StatefulWidget {
  ...
  @override
  State<LearningAlfatihah5Widget> createState() =>
      _LearningAlfatihah5WidgetState();
}

class _LearningAlfatihah5WidgetState
    extends State<LearningAlfatihah5Widget> {
                            ...
                            IconButton(
                              ...
                              onPressed: () {
                                Navigator.pushReplacement(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => LearningAlfatihah4Widget(),
                                  ),
                                );
                              },
                            ),
